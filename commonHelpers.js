var I=(t,o,e)=>{if(!o.has(t))throw TypeError("Cannot "+e)};var l=(t,o,e)=>(I(t,o,"read from private field"),e?e.call(t):o.get(t)),g=(t,o,e)=>{if(o.has(t))throw TypeError("Cannot add the same private member more than once");o instanceof WeakSet?o.add(t):o.set(t,e)};import{i as x,a as T,b as _,c as M,d as N}from"./assets/dark-light-switcher-48693140.js";import{a as u,N as S,n as O}from"./assets/vendor-83fc1255.js";function q(t){const o=document.getElementById("bookModal");o.innerHTML="";const e=document.createElement("div");e.classList.add("modal-content"),e.innerHTML=`
